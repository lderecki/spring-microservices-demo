...
public class AuthServerConfig {
    ...
    @Bean
    public RegisteredClientRepository apiClientRepo() {
        ...
        RegisteredClient apiClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("http://127.0.0.1:8081/login/oauth2/code/"+clientId+"-oidc")
